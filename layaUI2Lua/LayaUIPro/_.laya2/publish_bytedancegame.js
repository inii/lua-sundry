...
const provider = "ttaa3fdc823515af57";
const fullRemoteEngineList = ["laya.core.min.js", "laya.ttmini.min.js", "laya.webgl.min.js", "laya.ui.min.js", "laya.tiledmap.min.js", 
...
gulp.task("modifyFile_ByteDance", ["copyPlatformFile_Byte"], function() {
	// 修改game.json文件
...
gulp.task("version_Byte", ["modifyFile_ByteDance"], function() {
	if (config.version) {
...
gulp.task("pluginEngin_Byte", ["version_Byte"], function(cb) {
...
gulp.task("buildByteProj", ["pluginEngin_Byte"], function() {
